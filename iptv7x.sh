...
#下载开机运行脚本
echo 正在下载新文件
wget -q --no-check-certificate https://raw.githubusercontent.com/cairenbin/SH-4K-IPTV-Merlin/master/nat-start
#设置权限
...
#下载新配置文件
echo 正在下载新文件
wget -q --no-check-certificate https://raw.githubusercontent.com/cairenbin/SH-4K-IPTV-Merlin/master/iptv.conf
#设置权限
